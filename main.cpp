...
void display(GLFWwindow* window, double currentTime) {
	...
	mMat = glm::mat4(1.0f);
	mMat = glm::translate(mMat, glm::vec3(0.0f, 0.0f, -1.0f));
	...
	mMat = glm::rotate(mMat, glm::radians(models[2].rotation.x), glm::vec3(1.0f, 0.0f, 0.0f));
	...
	mMat = glm::rotate(mMat, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
