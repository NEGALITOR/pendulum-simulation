...
void setupVertices(void) {
	...
	// or 108 points.
	float vertexPositions[144] = {
		-2.0f,  1.0f, -1.0f, -2.0f, -1.0f, -1.0f, 2.0f, -1.0f, -1.0f, //red
		2.0f, -1.0f, -1.0f, 2.0f,  1.0f, -1.0f, -2.0f,  1.0f, -1.0f,
		2.0f, -1.0f, -1.0f, 2.0f, -1.0f,  1.0f, 2.0f,  1.0f, -1.0f, //green
		2.0f, -1.0f,  1.0f, 2.0f,  1.0f,  1.0f, 2.0f,  1.0f, -1.0f,
		2.0f, -1.0f,  1.0f, -2.0f, -1.0f,  1.0f, 2.0f,  1.0f,  1.0f, //blue
		-2.0f, -1.0f,  1.0f, -2.0f,  1.0f,  1.0f, 2.0f,  1.0f,  1.0f,
		-2.0f, -1.0f,  1.0f, -2.0f, -1.0f, -1.0f, -2.0f,  1.0f,  1.0f, //cyan
		-2.0f, -1.0f, -1.0f, -2.0f,  1.0f, -1.0f, -2.0f,  1.0f,  1.0f,
		-2.0f, -1.0f,  1.0f,  2.0f, -1.0f,  1.0f,  2.0f, -1.0f, -1.0f, //violet
		2.0f, -1.0f, -1.0f, -2.0f, -1.0f, -1.0f, -2.0f, -1.0f,  1.0f,
		-2.0f,  1.0f, -1.0f, 2.0f,  1.0f, -1.0f, 2.0f,  1.0f,  1.0f, //yellow
		2.0f,  1.0f,  1.0f, -2.0f,  1.0f,  1.0f, -2.0f,  1.0f, -1.0f,

		-2.0f, 1.0f, 1.0f, 2.0f, 1.0f, 1.0f, 2.0f, 0.0f,  2.0f, //white
		2.0f, 0.0f,  2.0f, -2.0f, 0.0f, 2.0f, -2.0f, 1.0f, 1.0f,

		-2.0f, -1.0f, 1.0f, 2.0f, -1.0f, 1.0f, 2.0f, 0.0f,  2.0f, //grey
		2.0f, 0.0f,  2.0f, -2.0f, 0.0f, 2.0f, -2.0f, -1.0f, 1.0f,
	};

	float vertexColors[144] = {
